...
@Inject
public class PlayerJoinHandler implements KernelListener {
    private final PaperService paperService;
    private final TemplateService templateService;

    public PlayerJoinHandler(PaperService paperService, TemplateService templateService) {
    ...
    private void on(PlayerJoinTeamEvent event) {
        ...
        this.paperService.translations()
            .of(this.templateService, "event.team.join")
        ...
        event.player().bukkit()
            .ifPresent(player -> this.paperService.translations()
                .of(this.templateService, "event.team.player.join")
